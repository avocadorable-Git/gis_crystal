...
$result = $conn->query("SELECT * FROM product_groups ORDER BY id DESC");
?>
<div class="page-header">
  <div><div class="page-title">Product Groups</div><div class="page-subtitle">Manage all Product Group records</div></div>
...
<div class="card"><div class="table-wrap"><table>
  ...
  <?php if ($result->num_rows===0): ?>
    <tr><td colspan="5"><div class="empty-state"><i class="bi bi-inbox"></i><p>No records yet. <a href="create.php" style="color:var(--accent)">Add one →</a></p></div></td></tr>
